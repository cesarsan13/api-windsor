...
class CalificacionesController extends Controller
{
    ...
    public function getCalificacionesMateria(Request $request)
    {
        ...
        Log::info("voy en el bimestre ".$request->bimestre);
        // Obtener la materia y calificaciones
        ...
        $data = [];
        // Verificar si la materia tiene actividad
        if (!$materia) {
            $response = ObjectResponse::CorrectResponse();
        ...
        if ($materia->actividad === "no") {
            // Si no hay actividad, calcular el total de calificaciones
            ...
            foreach ($cali as $cal) {
                ...
                // Sumamos las calificaciones filtradas
